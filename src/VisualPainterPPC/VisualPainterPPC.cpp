...
//				AllKeys(TRUE);
				...
				HMENU hMenu = (HMENU)SendMessage(g_hwndCB, SHCMBM_GETMENU, 0, 0);
				HMENU hSubMenu = ::GetSubMenu(hMenu, 0);
				AppendMenu(hMenu, MF_POPUP | MF_STRING | MF_ENABLED | MF_UNCHECKED, UINT(hSubMenu), L"Menu");
				RemoveMenu(hSubMenu, 0, MF_BYPOSITION);
				app.SetMenu(hSubMenu);
